python labelme2yolo.py ./dataset/images ./dataset/raw_dataset/images_yolo
...
yolo task=detect mode=train model=yolov8l.pt data=./dataset/augmented_dataset/data.yaml epochs=150 imgsz=640 batch=8 device=0  name=yolo8_bag_exp seed=42 lr0=0.0001 mosaic=0.5 fliplr=0.5
